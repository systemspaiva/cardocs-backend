...
gcloud run deploy cardocs-backend \
  ...
  --update-env-vars "GENKIT_INVOICE_EXTRACTION_ENABLED=true,GENKIT_INVOICE_MODEL=${GENKIT_INVOICE_MODEL:-${GEMINI_INVOICE_MODEL:-gemini-3-flash-preview}},GENKIT_INVOICE_TIMEOUT_MS=${GENKIT_INVOICE_TIMEOUT_MS:-${GEMINI_INVOICE_TIMEOUT_MS:-30000}},GEMINI_INVOICE_EXTRACTION_ENABLED=true,GEMINI_INVOICE_MODEL=${GEMINI_INVOICE_MODEL:-gemini-3-flash-preview},GEMINI_INVOICE_TIMEOUT_MS=${GEMINI_INVOICE_TIMEOUT_MS:-30000},GEMINI_PART_RECOMMENDATION_ENABLED=true,GEMINI_PART_RECOMMENDATION_MODEL=${GEMINI_PART_RECOMMENDATION_MODEL:-${GEMINI_INVOICE_MODEL:-gemini-3-flash-preview}},GEMINI_PART_RECOMMENDATION_TIMEOUT_MS=${GEMINI_PART_RECOMMENDATION_TIMEOUT_MS:-${GEMINI_INVOICE_TIMEOUT_MS:-30000}},CARDOCS_APP_STORE_ENVIRONMENT=${CARDOCS_APP_STORE_ENVIRONMENT:-Sandbox},CARDOCS_IOS_BUNDLE_ID=${CARDOCS_IOS_BUNDLE_ID:-com.paivaapps.cardocs},CARDOCS_APP_APPLE_ID=${CARDOCS_APP_APPLE_ID:-6768390243}" \
