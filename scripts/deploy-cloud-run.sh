...
gcloud run deploy cardocs-backend \
  ...
  --update-env-vars "GEMINI_INVOICE_EXTRACTION_ENABLED=true,GEMINI_INVOICE_MODEL=${GEMINI_INVOICE_MODEL:-gemini-3-flash-preview},GEMINI_INVOICE_TIMEOUT_MS=${GEMINI_INVOICE_TIMEOUT_MS:-30000}" \
