...
gcloud run deploy cardocs-backend \
  ...
  --update-env-vars "CARDOCS_IA_BASE_URL=${CARDOCS_IA_BASE_URL_VALUE},CARDOCS_IA_TIMEOUT_MS=${CARDOCS_IA_TIMEOUT_MS:-30000},CARDOCS_APP_STORE_ENVIRONMENT=${CARDOCS_APP_STORE_ENVIRONMENT:-Sandbox},CARDOCS_IOS_BUNDLE_ID=${CARDOCS_IOS_BUNDLE_ID:-com.paivaapps.cardocs},CARDOCS_APP_APPLE_ID=${CARDOCS_APP_APPLE_ID:-6768390243}" \
